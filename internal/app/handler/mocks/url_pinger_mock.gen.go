...
func (mr *MockPingerMockRecorder) PingPg(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PingPg", reflect.TypeOf((*MockPinger)(nil).PingPg), ctx)
}
